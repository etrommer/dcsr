...
class Uint16Vector(object):
    ...
    def Values(self, j):
        ...
        if o != 0:
            a = self._tab.Vector(o)
            return self._tab.Get(
                flatbuffers.number_types.Uint16Flags, a + flatbuffers.number_types.UOffsetTFlags.py_type(j * 2)
            )
        return 0
...
def CompressedSparsityAddRowOffsets(builder, rowOffsets):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rowOffsets), 0)
...
def CompressedSparsityAddDeltaIndices(builder, deltaIndices):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(deltaIndices), 0)
...
def CompressedSparsityAddGroupMinimums(builder, groupMinimums):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(groupMinimums), 0)
...
def CompressedSparsityAddBitmaps(builder, bitmaps):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(bitmaps), 0)
...
def CompressedSparsityAddBitmasks(builder, bitmasks):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(bitmasks), 0)
...
def CompressedSparsityAddNnze(builder, nnze):
    builder.PrependUint32Slot(5, nnze, 0)
...
def SparsityParametersAddCompSparsity(builder, compSparsity):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(compSparsity), 0)
...
class SparsityParametersT(object):
    ...
    def __init__(self):
        ...
        self.compSparsity = None  # type: Optional[CompressedSparsityT]
    ...
    def _UnPack(self, sparsityParameters):
        ...
        if sparsityParameters.CompSparsity() is not None:
            self.compSparsity = CompressedSparsityT.InitFromObj(sparsityParameters.CompSparsity())
...
class Operator(object):
    ...
    def MutatingVariableInputs(self, j):
        ...
        if o != 0:
            a = self._tab.Vector(o)
            return self._tab.Get(
                flatbuffers.number_types.BoolFlags, a + flatbuffers.number_types.UOffsetTFlags.py_type(j * 1)
            )
        return 0
...
def SignatureDefAddMethodName(builder, methodName):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(methodName), 0)
