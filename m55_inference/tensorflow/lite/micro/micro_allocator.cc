    ...
    namespace internal
    {
            ...
            ErrorReporter *error_reporter, TfLiteTensor *result)
        {
            ...
            *result = {};
            ...
            if (src_sparsity && src_sparsity->comp_sparsity()
                // TODO: Check remaining paramaters as well
            )
            {
                ...
                sparsity->bitmaps = src_sparsity->comp_sparsity()->bitmaps()->data();
                sparsity->bitmasks = src_sparsity->comp_sparsity()->bitmasks()->data();
                sparsity->delta_indices = src_sparsity->comp_sparsity()->delta_indices()->data();
                sparsity->group_minimums = src_sparsity->comp_sparsity()->group_minimums()->data();
                sparsity->row_offsets = src_sparsity->comp_sparsity()->row_offsets()->data();
                sparsity->nnze = src_sparsity->comp_sparsity()->nnze();
