...
struct CompressedSparsity;
struct CompressedSparsityBuilder;
struct CompressedSparsityT;
...
struct CompressedSparsityT : public flatbuffers::NativeTable {
  typedef CompressedSparsity TableType;
  std::vector<int16_t> row_offsets;
  std::vector<uint8_t> delta_indices;
  std::vector<int8_t> group_minimums;
...
struct CompressedSparsity FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef CompressedSparsityT NativeTableType;
  typedef CompressedSparsityBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ROW_OFFSETS = 4,
    VT_DELTA_INDICES = 6,
    VT_GROUP_MINIMUMS = 8,
  ...
  const flatbuffers::Vector<int16_t> *row_offsets() const {
    return GetPointer<const flatbuffers::Vector<int16_t> *>(VT_ROW_OFFSETS);
  }
  const flatbuffers::Vector<uint8_t> *delta_indices() const {
    return GetPointer<const flatbuffers::Vector<uint8_t> *>(VT_DELTA_INDICES);
  }
  const flatbuffers::Vector<int8_t> *group_minimums() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_GROUP_MINIMUMS);
  }
  const flatbuffers::Vector<uint8_t> *bitmaps() const {
    return GetPointer<const flatbuffers::Vector<uint8_t> *>(VT_BITMAPS);
  }
  const flatbuffers::Vector<uint16_t> *bitmasks() const {
    return GetPointer<const flatbuffers::Vector<uint16_t> *>(VT_BITMASKS);
  }
  uint32_t nnze() const {
    return GetField<uint32_t>(VT_NNZE, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_ROW_OFFSETS) &&
           verifier.VerifyVector(row_offsets()) &&
           VerifyOffset(verifier, VT_DELTA_INDICES) &&
           verifier.VerifyVector(delta_indices()) &&
           VerifyOffset(verifier, VT_GROUP_MINIMUMS) &&
           verifier.VerifyVector(group_minimums()) &&
           VerifyOffset(verifier, VT_BITMAPS) &&
           verifier.VerifyVector(bitmaps()) &&
           VerifyOffset(verifier, VT_BITMASKS) &&
           verifier.VerifyVector(bitmasks()) &&
           VerifyField<uint32_t>(verifier, VT_NNZE) &&
           verifier.EndTable();
  }
  CompressedSparsityT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(CompressedSparsityT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<CompressedSparsity> Pack(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparsityT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct CompressedSparsityBuilder {
  typedef CompressedSparsity Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_row_offsets(flatbuffers::Offset<flatbuffers::Vector<int16_t>> row_offsets) {
    fbb_.AddOffset(CompressedSparsity::VT_ROW_OFFSETS, row_offsets);
  }
  void add_delta_indices(flatbuffers::Offset<flatbuffers::Vector<uint8_t>> delta_indices) {
    fbb_.AddOffset(CompressedSparsity::VT_DELTA_INDICES, delta_indices);
  }
  void add_group_minimums(flatbuffers::Offset<flatbuffers::Vector<int8_t>> group_minimums) {
    fbb_.AddOffset(CompressedSparsity::VT_GROUP_MINIMUMS, group_minimums);
  }
  void add_bitmaps(flatbuffers::Offset<flatbuffers::Vector<uint8_t>> bitmaps) {
    fbb_.AddOffset(CompressedSparsity::VT_BITMAPS, bitmaps);
  }
  void add_bitmasks(flatbuffers::Offset<flatbuffers::Vector<uint16_t>> bitmasks) {
    fbb_.AddOffset(CompressedSparsity::VT_BITMASKS, bitmasks);
  }
  void add_nnze(uint32_t nnze) {
    fbb_.AddElement<uint32_t>(CompressedSparsity::VT_NNZE, nnze, 0);
  }
  explicit CompressedSparsityBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  CompressedSparsityBuilder &operator=(const CompressedSparsityBuilder &);
  flatbuffers::Offset<CompressedSparsity> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<CompressedSparsity>(end);
    return o;
  }
};

inline flatbuffers::Offset<CompressedSparsity> CreateCompressedSparsity(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<int16_t>> row_offsets = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> delta_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<int8_t>> group_minimums = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> bitmaps = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint16_t>> bitmasks = 0,
    uint32_t nnze = 0) {
  CompressedSparsityBuilder builder_(_fbb);
  builder_.add_nnze(nnze);
  builder_.add_bitmasks(bitmasks);
  builder_.add_bitmaps(bitmaps);
  builder_.add_group_minimums(group_minimums);
  builder_.add_delta_indices(delta_indices);
  builder_.add_row_offsets(row_offsets);
  return builder_.Finish();
}

inline flatbuffers::Offset<CompressedSparsity> CreateCompressedSparsityDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<int16_t> *row_offsets = nullptr,
    const std::vector<uint8_t> *delta_indices = nullptr,
    const std::vector<int8_t> *group_minimums = nullptr,
    const std::vector<uint8_t> *bitmaps = nullptr,
    const std::vector<uint16_t> *bitmasks = nullptr,
    uint32_t nnze = 0) {
  auto row_offsets__ = row_offsets ? _fbb.CreateVector<int16_t>(*row_offsets) : 0;
  auto delta_indices__ = delta_indices ? _fbb.CreateVector<uint8_t>(*delta_indices) : 0;
  auto group_minimums__ = group_minimums ? _fbb.CreateVector<int8_t>(*group_minimums) : 0;
  auto bitmaps__ = bitmaps ? _fbb.CreateVector<uint8_t>(*bitmaps) : 0;
  auto bitmasks__ = bitmasks ? _fbb.CreateVector<uint16_t>(*bitmasks) : 0;
  return tflite::CreateCompressedSparsity(
      _fbb,
      row_offsets__,
      delta_indices__,
      group_minimums__,
...
flatbuffers::Offset<CompressedSparsity> CreateCompressedSparsity(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparsityT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct SparsityParametersT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<tflite::CompressedSparsityT> comp_sparsity;
  SparsityParametersT() {
  }
};
...
struct SparsityParameters FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const tflite::CompressedSparsity *comp_sparsity() const {
    return GetPointer<const tflite::CompressedSparsity *>(VT_COMP_SPARSITY);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_COMP_SPARSITY) &&
           verifier.VerifyTable(comp_sparsity()) &&
           verifier.EndTable();
  }
...
struct SparsityParametersBuilder {
  ...
  void add_comp_sparsity(flatbuffers::Offset<tflite::CompressedSparsity> comp_sparsity) {
    fbb_.AddOffset(SparsityParameters::VT_COMP_SPARSITY, comp_sparsity);
  }
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParameters(
    ...
    flatbuffers::Offset<tflite::CompressedSparsity> comp_sparsity = 0) {
  SparsityParametersBuilder builder_(_fbb);
  builder_.add_comp_sparsity(comp_sparsity);
...
inline CompressedSparsityT *CompressedSparsity::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tflite::CompressedSparsityT> _o = std::unique_ptr<tflite::CompressedSparsityT>(new CompressedSparsityT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void CompressedSparsity::UnPackTo(CompressedSparsityT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = row_offsets(); if (_e) { _o->row_offsets.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->row_offsets[_i] = _e->Get(_i); } } }
  { auto _e = delta_indices(); if (_e) { _o->delta_indices.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->delta_indices[_i] = _e->Get(_i); } } }
  { auto _e = group_minimums(); if (_e) { _o->group_minimums.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->group_minimums[_i] = _e->Get(_i); } } }
  { auto _e = bitmaps(); if (_e) { _o->bitmaps.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->bitmaps[_i] = _e->Get(_i); } } }
  { auto _e = bitmasks(); if (_e) { _o->bitmasks.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->bitmasks[_i] = _e->Get(_i); } } }
  { auto _e = nnze(); _o->nnze = _e; }
}

inline flatbuffers::Offset<CompressedSparsity> CompressedSparsity::Pack(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparsityT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateCompressedSparsity(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<CompressedSparsity> CreateCompressedSparsity(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparsityT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const CompressedSparsityT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _row_offsets = _o->row_offsets.size() ? _fbb.CreateVector(_o->row_offsets) : 0;
  auto _delta_indices = _o->delta_indices.size() ? _fbb.CreateVector(_o->delta_indices) : 0;
  auto _group_minimums = _o->group_minimums.size() ? _fbb.CreateVector(_o->group_minimums) : 0;
  auto _bitmaps = _o->bitmaps.size() ? _fbb.CreateVector(_o->bitmaps) : 0;
  auto _bitmasks = _o->bitmasks.size() ? _fbb.CreateVector(_o->bitmasks) : 0;
  auto _nnze = _o->nnze;
  return tflite::CreateCompressedSparsity(
      _fbb,
      _row_offsets,
...
inline void SparsityParameters::UnPackTo(SparsityParametersT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = comp_sparsity(); if (_e) _o->comp_sparsity = std::unique_ptr<tflite::CompressedSparsityT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParameters(flatbuffers::FlatBufferBuilder &_fbb, const SparsityParametersT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _comp_sparsity = _o->comp_sparsity ? CreateCompressedSparsity(_fbb, _o->comp_sparsity.get(), _rehasher) : 0;
  return tflite::CreateSparsityParameters(
      _fbb,
      _traversal_order,
      _block_map,
